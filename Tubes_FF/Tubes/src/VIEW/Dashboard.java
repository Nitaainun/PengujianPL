...
public class Dashboard extends javax.swing.JFrame {
    ...
    public Dashboard(int idUser, String username, String nama, String password, int no_telp, String jenis_kelamin) {
        initComponents();
        Dimension screenSize = 
        Toolkit.getDefaultToolkit().getScreenSize();
            Dimension frameSize = this.getSize();
...
//            ResultSet as = con.createStatement().executeQuery("select * from user where id='"+idUser+"'");
//            if(as.next()){
//                new DaftarCatatankeuangan(as.getInt(1), as.getString(2), as.getString(3), as.getString(4), as.getInt(5), as.getString(6)).setVisible(true);
//                this.dispose();
//            }
